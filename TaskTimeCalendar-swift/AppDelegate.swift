...
//]
        ...
        */
        ...
        func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
            ...
            levels[Point.init(l: 0, s: 0)] = ContextState.init(name: ["states", "state"],
                                                               ...
                                                               data: [:])
            state_point_table[(levels[Point.init(l: 0, s: 0)]?.getName())!] = Point.init(l: 0, s: 0)
        
            levels[Point.init(l: 0, s: 1)] = ContextState.init(name: ["level_number"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
                                                               ...
                                                               function_name: "returnTrue",
                                                               data: ["Int": 0])
            state_point_table[(levels[Point.init(l: 0, s: 1)]?.getName())!] = Point.init(l: 0, s: 1)
            
            levels[Point.init(l: 0, s: 2)] = ContextState.init(name: ["state_id"],
                                                                   start_children: [],
                                                                   parents: [],
                                                                   children: [],
                                                                   nexts: [],
                                                                   ...
                                                                   function_name: "returnTrue",
                                                                   data: ["Int": 0])
            state_point_table[(levels[Point.init(l: 0, s: 2)]?.getName())!] = Point.init(l: 0, s: 2)
            
            levels[Point.init(l: 0, s: 3)] = ContextState.init(name: ["indent_1"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
                                                               ...
                                                               function_name: "returnTrue",
                                                               data: ["Int": 0])
            state_point_table[(levels[Point.init(l: 0, s: 3)]?.getName())!] = Point.init(l: 0, s: 3)
            
            levels[Point.init(l: 0, s: 4)] = ContextState.init(name: ["indent_2"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
                                                               ...
                                                               function_name: "returnTrue",
                                                               data: ["Int": 0])
            state_point_table[(levels[Point.init(l: 0, s: 4)]?.getName())!] = Point.init(l: 0, s: 4)

            levels[Point.init(l: 0, s: 5)] = ContextState.init(name: ["tracking", "level_state"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
                                                               ...
                                                               function_name: "returnTrue",
                                                               data: ["Int": 0])
            state_point_table[(levels[Point.init(l: 0, s: 5)]?.getName())!] = Point.init(l: 0, s: 5)


            levels[Point.init(l: 0, s: 6)] = ContextState.init(name: ["tracking", "tree"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
                                                               ...
                                                               function_name: "returnTrue",
                                                               data: ["Int": 0])
            state_point_table[(levels[Point.init(l: 0, s: 6)]?.getName())!] = Point.init(l: 0, s: 6)
            
            
            levels[Point.init(l: 0, s: 7)] = ContextState.init(name: ["sparse_matrix"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
            ...
            state_point_table[(levels[Point.init(l: 0, s: 7)]?.getName())!] = Point.init(l: 0, s: 7)
            
            
            levels[Point.init(l: 0, s: 8)] = ContextState.init(name: ["input"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               nexts: [],
            ...
            state_point_table[(levels[Point.init(l: 0, s: 8)]?.getName())!] = Point.init(l: 0, s: 8)
            print("input is")
            print(levels[Point.init(l: 0, s: 8)]?.data["String"] as! String)
            
            print("\n\n")
            
                levels[Point.init(l: 1, s: 0)] = ContextState.init(name: ["names", "0"],
                                                                   ...
                                                                   function_name: "returnTrue",
                                                                   data: [:])
                state_point_table[(levels[Point.init(l: 1, s: 0)]?.getName())!] = Point.init(l: 1, s: 0)
            
                print("\n\n")
            
                    levels[Point.init(l: 2, s: 0)] = ContextState.init(name: ["name", "0"],
                                                                       start_children: [],
                                                                       parents: [["names", "0"]],
                                                                       children: [],
                                                                       ...
                                                                       function_name: "returnTrue",
                                                                       data: [:])
                    state_point_table[(levels[Point.init(l: 2, s: 0)]?.getName())!] = Point.init(l: 2, s: 0)
                    print("\n\n")
            
                    levels[Point.init(l: 2, s: 1)] = ContextState.init(name: ["indent_increase", "0"],
                                                               start_children: [],
                                                               parents: [],
                                                               children: [],
                                                               ...
                                                               data: [:])
                    state_point_table[(levels[Point.init(l: 2, s: 1)]?.getName())!] = Point.init(l: 2, s: 1)
                    print("\n\n")
            
                    levels[Point.init(l: 2, s: 2)] = ContextState.init(name: ["indent_increase", "1"],
                                                                       start_children: [],
                                                                       parents: [],
                                                                       children: [],
                                                                       ...
                                                                       function_name: "returnTrue",
                                                                       data: [:])
                    state_point_table[(levels[Point.init(l: 2, s: 2)]?.getName())!] = Point.init(l: 2, s: 2)
                    print("\n\n")


                    // the recursion will be detected by the positive level difference between the current state and the Start Children State
                    levels[Point.init(l: 2, s: 3)] = ContextState.init(name: ["indent_increase", "2"],
                                                                       start_children: [["names", "0"]],
                                                                       parents: [],
                                                                       children: [],
                                                                       ...
                                                                       function_name: "returnTrue",
                                                                       data: [:])
                    state_point_table[(levels[Point.init(l: 2, s: 3)]?.getName())!] = Point.init(l: 2, s: 3)
                    print("\n\n")

                    levels[Point.init(l: 2, s: 4)] = ContextState.init(name: ["\"Start Children\"", "0"],
                                                                       start_children: [/*["names", "0"]*/],
                                                                       parents: [],
                                                                       children: [],
                                                                       nexts: [],
                    ...
                    state_point_table[(levels[Point.init(l: 2, s: 4)]?.getName())!] = Point.init(l: 2, s: 4)
                    print("\n\n")
            
                    levels[Point.init(l: 2, s: 5)] = ContextState.init(name: ["indent_decrease", "0"],
                                                                       start_children: [],
                                                                       parents: [],
                                                                       children: [],
                                                                       nexts: [],
                                                                       ...
                                                                       function_name: "returnTrue",
                                                                       data: [:])
                    state_point_table[(levels[Point.init(l: 2, s: 5)]?.getName())!] = Point.init(l: 2, s: 5)
                    print("\n\n")
            
                    levels[Point.init(l: 2, s: 6)] = ContextState.init(name: ["indent_decrease", "1"],
                                                                       start_children: [],
                                                                       parents: [],
                                                                       children: [],
                                                                       nexts: [],
                                                                       ...
                                                                       function_name: "returnFalse",
                                                                       data: [:])
                    state_point_table[(levels[Point.init(l: 2, s: 6)]?.getName())!] = Point.init(l: 2, s: 6)
                    print("\n\n")
            
            
            
                levels[Point.init(l: 1, s: 1)] = ContextState.init(name: ["start_children", "0"],
                                                                   ...
                                                                   function_name: "returnTrue",
                                                                   data: [:])
                state_point_table[(levels[Point.init(l: 1, s: 1)]?.getName())!] = Point.init(l: 1, s: 1)
            ...
            ContextState.init(name: <#T##[String]#>,
                ...
                */
            var visitor_class: Visit = Visit.init(next_states: [(levels[Point.init(l: 0, s: 0)]!.getName())],
                                                  current_state_name:    (levels[Point.init(l: 0, s: 0)]?.getName())!,
                                                  ...
                                                  dummy_node:            ContextState.init(name:["root", "0"],
                                                                                           ...
                                                                                           function_name: "returnTrue",
                                                                                           data: [:]),
                                                  state_point_table:     state_point_table,
                                                  levels:                levels)
            visitor_class.visitStates(start_state: levels[Point.init(l: 0, s: 0)]!,
                                      end_state: levels[Point.init(l: 0, s: 0)]!)
